...
export const ListaTareas = () => {
    ...
    const agregarTarea = (event) => {
        ...
        dispatch(action)
        resetField('tarea') // Limpiar solo el input de tarea
    }
            ...
            <form onSubmit={agregarTarea}>
                <div className="form-group">
                    <label htmlFor="tarea">
                        ...
                        <input type="text" className="form-control" name="tarea" placeholder="Ingrese tarea" value={tarea} onChange={onInputChange}></input>
                    </label>
                </div>
